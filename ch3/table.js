...
const export_bytes = fs.readFileSync(path.join(__dirname, 'table_export.wasm'));
const test_bytes = fs.readFileSync(path.join(__dirname, 'table_test.wasm'));
let i = 0;
let increment = () => {
    i++;
    return i;
...
(async () => {
    ...
    console.log(obj.instance.exports.decrement_test())
})();